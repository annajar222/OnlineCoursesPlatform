        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <div v-if="$page.user.is_admin" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </jet-nav-link>

                                <jet-nav-link :href="route('admin.profiles')" :active="route().current('admin.profiles')">
                                    Manage Accounts
                                </jet-nav-link>
                            </div>
                            ...
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <div v-if="$page.user.is_admin">
                                        <jet-dropdown-link :href="route('show.emails')">
                                            Emails
                                        </jet-dropdown-link>
                                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <div v-if="$page.user.is_admin">
                        <jet-responsive-nav-link :href="route('admin.profiles')" :active="route().current('Admin.profiles')">
                            Manage Accounts
                        </jet-responsive-nav-link>
                    </div>
